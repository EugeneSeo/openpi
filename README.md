...
This checkout also contains DreamDifferent/ETH Euler-specific Franka/ORCA
training wrappers and configs used for local baseline experiments.

If you are looking for those project-specific scripts rather than the upstream
OpenPI usage docs below, start here:
